...
This disclosure publicly documents a combined process flow that integrates state-issued e-affidavits, notarization metadata, off-chain permanent storage, permissioned ledgers, and public-chain anchoring, specifically for testamentary documents and land-beneficiary designation in Lagos,Nigerian States & African Countries. This publication is intended to prevent future patenting of the same process by third parties.
